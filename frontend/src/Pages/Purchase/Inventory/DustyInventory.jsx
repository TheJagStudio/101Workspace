		...
		measures: [
			{
				...
				definition: "Percentage of items sold out of all items available for sale",
			},
			{
				measure: "Inventory cost",
				definition: "Value of inventory available at the end of the reporting period, based on the average cost as at the end of the period",
			},
			{
				measure: "Retail value (excl. tax)",
				definition: "Value of inventory available at the end of the reporting period, calculated using retail price",
			},
		],
	},
	other: {
		...
		measures: [
			...
			{
				measure: "Last sale",
				definition: "Date of the last sale within the reporting period",
			},
			{
				measure: "Last received",
				definition: "Date this product was last received on a purchase order",
			},
		],
	},
};
...
const DustyInventory = () => {
	...
	return (
		<div className="px-5">
			<p className="text-3xl font-semibold text-gray-700">Dusty Inventory</p>
			<div className={"bg-white select-none w-full h-fit rounded-lg shadow-md mt-5 p-4 items-end justify-start flex flex-row flex-wrap gap-x-4 gap-y-1 " + (loading ? "opacity-50 pointer-events-none" : "")}>
				...
				{reportType === "category" && (
					...
					>
						<rect x={9} y={2} width={6} height={6} rx={1} stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
						<path d="M4 18v-4a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v4" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
						...
						<circle cx={12} cy={20} r={2} stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
						<path d="M12 8v10" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
					</svg>
				)}
			...
			<div className={"mt-5 relative bg-white w-full h-[calc(100vh-23rem)] rounded-lg shadow-md overflow-hidden text-gray-700 transition-all duration-500 " + (collapsed ? "max-w-[calc(100vw-10rem)]" : "max-w-[calc(100vw-18rem)]")}>
				{loading && (
