...
class DDGS:
        ...
        for _ in range(5):
            ...
            for e in elements:
                if isinstance(e, _Element):
                    ...
                    if href and href not in cache and not href.startswith(("http://www.google.com/search?q=", "https://duckduckgo.com/y.js?ad_domain")):
                        cache.add(href)
            ...
            for i, e in data:
                if isinstance(e, _Element):
                    if i == 1:
                        hrefxpath = e.xpath(".//a//@href")
                        href = str(hrefxpath[0]) if hrefxpath and isinstance(hrefxpath, list) else None
                        if href is None or href in cache or href.startswith(("http://www.google.com/search?q=", "https://duckduckgo.com/y.js?ad_domain")):
    ...
    def images(
        ...
        for _ in range(5):
            resp_content = self._get_url("GET", "https://duckduckgo.com/i.js", params=payload, headers={"Referer": "https://duckduckgo.com/"}).content
